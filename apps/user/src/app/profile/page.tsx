      ...
      <div className="rounded-2xl border border-gray-200 bg-white p-8 shadow-sm space-y-6">
        ...
        <div className="flex items-center justify-between">
          ...
          <button
            ...
            className="rounded-lg border border-rose-400 px-4 py-2 text-sm font-semibold text-rose-500 hover:bg-rose-50 transition-colors"
          >
            닉네임 변경
          </button>
        </div>
        ...
        <div className="flex items-center justify-between border-t border-gray-100 pt-6">
          <div>
            <label className="block text-sm font-medium text-gray-500 mb-1">비밀번호</label>
